...
import ru.mixail_akulov.a33_mvvm_flows2.R
import ru.mixail_akulov.a33_mvvm_flows2.foundation.model.PendingResult
import ru.mixail_akulov.a33_mvvm_flows2.foundation.model.SuccessResult
import ru.mixail_akulov.a33_mvvm_flows2.foundation.model.takeSuccess
import ru.mixail_akulov.a33_mvvm_flows2.foundation.sideeffects.dialogs.Dialogs
import ru.mixail_akulov.a33_mvvm_flows2.foundation.sideeffects.dialogs.plugin.DialogConfig
...
import ru.mixail_akulov.a33_mvvm_flows2.foundation.sideeffects.permissions.Permissions
import ru.mixail_akulov.a33_mvvm_flows2.foundation.sideeffects.permissions.plugin.PermissionStatus
...
import ru.mixail_akulov.a33_mvvm_flows2.foundation.views.BaseViewModel
import ru.mixail_akulov.a33_mvvm_flows2.foundation.views.LiveResult
import ru.mixail_akulov.a33_mvvm_flows2.foundation.views.MutableLiveResult
import ru.mixail_akulov.a33_mvvm_flows2.simplemvvm.model.colors.ColorsRepository
import ru.mixail_akulov.a33_mvvm_flows2.simplemvvm.model.colors.NamedColor
import ru.mixail_akulov.a33_mvvm_flows2.simplemvvm.views.changecolor.ChangeColorFragment
